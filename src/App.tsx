      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 z-10">
        <div className="max-w-6xl w-full space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 h-[50vh]">
            <CharacterCard 
              name="Yuji" title="The Tiger" color="hover:shadow-[0_0_50px_rgba(255,204,0,0.5)] hover:border-yellow-500" glowColor="bg-yellow-500" stats={{ hp: 100, ce: 100, dmg: 'High', speed: 'Med' }}
              selected={character === 'Yuji'}
              onClick={() => { soundManager.playClick(); setCharacter('Yuji'); }}
            />
            <CharacterCard 
              name="Gojo" title="The Strongest" color="hover:shadow-[0_0_50px_rgba(138,43,226,0.5)] hover:border-purple-500" glowColor="bg-purple-500" stats={{ hp: 100, ce: 100, dmg: 'Max', speed: 'High' }}
              selected={character === 'Gojo'}
              onClick={() => { soundManager.playClick(); setCharacter('Gojo'); }}
            />
            <CharacterCard 
              name="Sukuna" title="King of Curses" color="hover:shadow-[0_0_50px_rgba(255,0,0,0.5)] hover:border-red-500" glowColor="bg-red-500" stats={{ hp: 100, ce: 100, dmg: 'High', speed: 'High' }}
